...
이번 프로젝트를 통해 Spring Boot 애플리케이션의 **성능 최적화**에 있어 **부하 테스트와 모니터링**의 중요성을 재확인하였습니다. JMeter로 실제 사용 환경과 유사한 부하를 생성함으로써 잠재적인 문제점을 발견할 수 있었고, Prometheus와 Grafana를 통해 수집된 데이터로 명확한 개선 방향을 설정할 수 있었습니다. 이러한 과정은 안정적이고 효율적인 애플리케이션 운영을 위한 중요한 기반이 될 것입니다.
